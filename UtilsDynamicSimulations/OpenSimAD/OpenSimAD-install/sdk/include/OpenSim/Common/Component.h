...
//==============================================================================
    ...
    */
     ...
     *         System (i.e., if initSystem has not been called)
     */
	osim_double_adouble getStateVariableValue(const SimTK::State& state, const std::string& name) const;
     ...
     *         System (i.e., if initSystem has not been called)
     */
    void setStateVariableValue(SimTK::State& state, const std::string& name, osim_double_adouble value) const;
     ...
     *         System (i.e., if initSystem has not been called)
     */
	osim_double_adouble getStateVariableDerivativeValue(const SimTK::State& state,
     ...
     *         System (i.e., if initSystem has not been called)
     */
	osim_double_adouble getDiscreteVariableValue(const SimTK::State& state,
                                    const std::string& name) const;
    ...
    void setDiscreteVariableValue(SimTK::State& state, const std::string& name,
		osim_double_adouble value) const;
...
protected:
    ...
    **/
    ...
    void setStateVariableDerivativeValue(const SimTK::State& state, 
                            const std::string& name, osim_double_adouble deriv) const;
...
protected:
    ...
    public:
        ...
        virtual osim_double_adouble getValue(const SimTK::State& state) const = 0;
        virtual void setValue(SimTK::State& state, osim_double_adouble value) const = 0;
        virtual osim_double_adouble getDerivative(const SimTK::State& state) const = 0;
        // The derivative a state should be a cache entry and thus does not
        // change the state
        virtual void setDerivative(const SimTK::State& state, osim_double_adouble deriv) const = 0;
