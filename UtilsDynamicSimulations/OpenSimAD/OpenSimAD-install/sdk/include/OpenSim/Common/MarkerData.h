...
//    osim_double_adouble _dataRate;
//    osim_double_adouble _cameraRate;
//    osim_double_adouble _originalDataRate;
...
//    virtual ~MarkerData();
//
//    void findFrameRange(osim_double_adouble aStartTime, osim_double_adouble aEndTime, int& rStartFrame, int& rEndFrame) const;
//    void averageFrames(osim_double_adouble aThreshold = -1.0, osim_double_adouble aStartTime = -SimTK::Infinity, osim_double_adouble aEndTime = SimTK::Infinity);
...
//    osim_double_adouble getStartFrameTime() const;
//    osim_double_adouble getLastFrameTime() const;
//    osim_double_adouble getDataRate() const { return _dataRate; }
//    osim_double_adouble getCameraRate() const { return _cameraRate; }
//
//private:
