...
//    int _numMarkers;
//    int _frameNumber;
//    osim_double_adouble _frameTime;
//    Units _units;
...
//public:
//    MarkerFrame();
//    MarkerFrame(int aNumMarkers, int aFrameNumber, osim_double_adouble aTime, Units& aUnits);
...
//    osim_double_adouble getFrameTime() const { return _frameTime; }
//    void scale(osim_double_adouble aScaleFactor);
//
