...
//    static const osim_double_adouble SMALLDX;
//protected:
//    /** Perturbation size for computing numerical derivatives. */
//    Array<osim_double_adouble> _dx;
//
////=============================================================================
//// METHODS
////=============================================================================
...
//    void setDX(osim_double_adouble aVal);
//    void setDX(int aIndex,osim_double_adouble aVal);
//    osim_double_adouble getDX(int aIndex);
//    osim_double_adouble* getDXArray();
//
//    // UTILITY
//    void validatePerturbationSize(osim_double_adouble &aSize);
//
//    virtual bool prepareToOptimize(SimTK::State& s, osim_double_adouble *x) { return false; }
//    virtual void printPerformance(osim_double_adouble *x);
//
//    static int
//        CentralDifferencesConstraint(const OptimizationTarget *aTarget,
//        osim_double_adouble *dx,const SimTK::Vector &x,SimTK::Matrix &jacobian);
//    static int
//        CentralDifferences(const OptimizationTarget *aTarget,
//        osim_double_adouble *dx,const SimTK::Vector &x,SimTK::Vector &dpdx);
//    static int
