...
//    // EVALUATE
//    //--------------------------------------------------------------------------
//    virtual void evaluate( const SimTK::State& s, const osim_double_adouble *aX, osim_double_adouble *rF) { 
//        std::cout << "VectorFunctionUncoupledNxN UNIMPLEMENTED: evaluate( const SimTK::State&, const double*, double*)" << std::endl;
//    }
//    virtual void evaluate( const SimTK::State& s, const Array<osim_double_adouble> &aX, Array<osim_double_adouble> &rF){
//        std::cout << "VectorFunctionUncoupledNxN UNIMPLEMENTED: evaluate( const SimTK::State&, const Array<double>, Array<double>)" << std::endl;
//    }
//    virtual void evaluate( const SimTK::State& s, const Array<osim_double_adouble> &aX, Array<osim_double_adouble> &rF, const Array<int> &aDerivWRT){
