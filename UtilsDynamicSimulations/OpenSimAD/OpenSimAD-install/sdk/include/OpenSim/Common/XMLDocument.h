...
//    bool isEqualTo(XMLDocument& aOtherDocument, osim_double_adouble toleranceForDoubles=1e-6, 
...
//
//private:
//    static bool isElementEqual(SimTK::Xml::Element& elt1, SimTK::Xml::Element& elt2, osim_double_adouble toleranceForDoubles);
