...
namespace OpenSim {
	...
	template<typename ETX = osim_double_adouble, typename ETY = osim_double_adouble>
...
//		}
		...
		DataTable_(const DataTable_<osim_double_adouble, ThatETY>& that,
			const std::vector<std::string>& suffixes) :
			AbstractDataTable{ that } {
			static_assert(std::is_same<ETY, osim_double_adouble>::value,
				"This constructor can only be used to construct "
				"DataTable_<double, double>.");
			static_assert(!std::is_same<ThatETY, osim_double_adouble>::value,
		...
		of 'that' DataTable.                              */
		explicit DataTable_(const DataTable_<osim_double_adouble, osim_double_adouble>& that,
			const std::vector<std::string>& suffixes) :
			AbstractDataTable{ that } {
			static_assert(!std::is_same<ETY, osim_double_adouble>::value,
		...
		elements as that.numComponentsPerElement().       */
		template<typename ThatETY>
		explicit DataTable_(const DataTable_<osim_double_adouble, ThatETY>& that) :
		...
		elements as that.numComponentsPerElement().       */
		template<typename ThatETY>
		DataTable_& operator=(const DataTable_<osim_double_adouble, ThatETY>& that) {
		...
		DataTable_<osim_double_adouble, osim_double_adouble> flatten() const {
			return DataTable_<osim_double_adouble, osim_double_adouble>{*this};
		}
		...
		documentation for constructor DataTable_::DataTable_().                   */
		DataTable_<osim_double_adouble, osim_double_adouble>
			flatten(const std::vector<std::string>& suffixes) const {
			return DataTable_<osim_double_adouble, osim_double_adouble>{*this, suffixes};
		}
		...
		documentation for constructor DataTable_::DataTable_().                   */
		template<typename ThatETY>
		DataTable_<osim_double_adouble, ThatETY> pack() const {
			return DataTable_<osim_double_adouble, ThatETY>{*this};
		}
		...
		documentation for constructor DataTable_::DataTable_().                   */
		template<typename ThatETY>
		DataTable_<osim_double_adouble, ThatETY>
			pack(const std::vector<std::string>& suffixes) const {
			return DataTable_<osim_double_adouble, ThatETY>{*this, suffixes};
		}
	...
	protected:
		...
		std::string toString_impl(std::vector<int> rows = {},
			...
			unsigned         maxWidth = 80,
			unsigned         precision = 4) const {
			static_assert(std::is_same<ETX, osim_double_adouble>::value,
			...
			auto toStr = [&](const osim_double_adouble val) {
		...
		template<int N>
		static
			void splitElementAndPushBack(std::vector<osim_double_adouble>& row,
		...
		// Unsupported type.
		static
			void splitElementAndPushBack(std::vector<osim_double_adouble>&,
				...) {
			static_assert(!std::is_same<ETY, osim_double_adouble>::value,
				"This constructor cannot be used to construct from "
		...
		static
			std::vector<osim_double_adouble> splitElement(const ELT& elt) {
			std::vector<osim_double_adouble> result{};
			splitElementAndPushBack(result, elt);
			return result;
		}
		static
			std::vector<osim_double_adouble> splitElement(const osim_double_adouble& elt) {
			return{ elt };
		}

		template<typename Iter>
		static
			void makeElement_helper(osim_double_adouble& elem,
				Iter begin, Iter end) {
	...
	typedef DataTable_<osim_double_adouble, osim_double_adouble> DataTable;
	/** See DataTable_ for details on the interface.                              */
	typedef DataTable_<osim_double_adouble, SimTK::Vec3> DataTableVec3;
