...
//                   osim_double_adouble constraintWeight = SimTK::Infinity);
//
...
//    void setAccuracy(osim_double_adouble accuracy);
//
...
//        minimize.*/
//    void setConstraintWeight(osim_double_adouble weight) {_constraintWeight = weight; }
//    
...
//    void updateCoordinateReference(const std::string &coordName, osim_double_adouble value, 
//                                   osim_double_adouble weight=1.0);
//
...
//    osim_double_adouble _accuracy;
//
//    // Weight for built-in constraints to be satisfied
//    osim_double_adouble _constraintWeight;
//
