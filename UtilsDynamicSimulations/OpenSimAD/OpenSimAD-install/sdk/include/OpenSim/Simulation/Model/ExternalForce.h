...
//     */
//    SimTK::Vec3 getForceAtTime(osim_double_adouble aTime) const;
//    SimTK::Vec3 getPointAtTime(osim_double_adouble aTime) const;
//    SimTK::Vec3 getTorqueAtTime(osim_double_adouble aTime) const;
//
//    /**
