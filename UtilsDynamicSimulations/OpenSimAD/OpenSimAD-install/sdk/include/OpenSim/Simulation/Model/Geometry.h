...
//    void setOpacity(const osim_double_adouble opacity) { 
//        upd_Appearance().set_opacity(opacity); 
//    };
//    /// Convenient access to get Appearance/Opacity
//    const osim_double_adouble getOpacity() { 
...
//        "direction of Arrow");
//
//    OpenSim_DECLARE_PROPERTY(length, osim_double_adouble, "length of Arrow");
//    /// constructor that takes startPoint, direction vector and length
//    Arrow(SimTK::Vec3& aPoint1, SimTK::UnitVec3& aUnitDir, osim_double_adouble aLength) 
//    {
//        constructProperties();
...
//public:
//    OpenSim_DECLARE_PROPERTY(radius, osim_double_adouble,
...
//    Sphere(osim_double_adouble radius):
//        AnalyticGeometry()
//        {
//        constructProperties();
//        upd_radius() = radius;
...
//    Ellipsoid(osim_double_adouble radius1, osim_double_adouble radius2, osim_double_adouble radius3):
//        AnalyticGeometry(){
//        constructProperties();
...
//    void setEllipsoidParams(osim_double_adouble radius1, osim_double_adouble radius2, osim_double_adouble radius3)
//    {
//        upd_radii()[0] = radius1;
//        upd_radii()[1] = radius2;
//        upd_radii()[2] = radius3;
...
//public:
//    // Property radius
//    OpenSim_DECLARE_PROPERTY(radius, osim_double_adouble, "Radius of cylinder.");
//    // Property half_height
//    OpenSim_DECLARE_PROPERTY(half_height, osim_double_adouble, "Half-Height of cylinder.");
//    /// Default constructor
//    Cylinder() :
//    AnalyticGeometry()
//    {
...
//    Cylinder(const osim_double_adouble radius, const osim_double_adouble hheight):
//        AnalyticGeometry()
//        {
//        constructProperties();
//        upd_radius() = radius;
...
//    OpenSim_DECLARE_PROPERTY(base_radius, osim_double_adouble, "Base radius of cone.");
//    OpenSim_DECLARE_PROPERTY(height, osim_double_adouble, "Height of cone.");
//    /// Default constructor
//    Cone() :
//        AnalyticGeometry()
//    {
...
//        osim_double_adouble height, osim_double_adouble base) :
//        AnalyticGeometry()
//    {
//        constructProperties();
//        upd_origin() = o;
...
//public:
//    OpenSim_DECLARE_PROPERTY(cross_section, osim_double_adouble, "Cross section radius");
//    OpenSim_DECLARE_PROPERTY(ring_radius, osim_double_adouble, "Radius of the torus ring.");
//public:
//    /// Default constructor
//    Torus():
//    AnalyticGeometry()
...
//    Torus(const osim_double_adouble ringRadius, const osim_double_adouble crossSectionRadius):
//    AnalyticGeometry()
//    {
...
//public:
//    OpenSim_DECLARE_PROPERTY(display_radius, osim_double_adouble,
//        "The radius of the arrow-shaft used to display the frame.");
//    /// Default constructor
//    FrameGeometry(osim_double_adouble scale=0.2) : Geometry()
//    {
//       constructProperties();
