...
//    osim_double_adouble &_lowpassCutoffFrequencyForLoadKinematics;
//
//private:
...
//    osim_double_adouble getLowpassCutoffFrequencyForLoadKinematics() const { return _lowpassCutoffFrequencyForLoadKinematics; }
//    void setLowpassCutoffFrequencyForLoadKinematics(osim_double_adouble aLowpassCutoffFrequency) { _lowpassCutoffFrequencyForLoadKinematics = aLowpassCutoffFrequency; }
//
//    void transformPointsExpressedInGroundToAppliedBodies(const Storage &kinematics, osim_double_adouble startTime = -SimTK::Infinity, osim_double_adouble endTime = SimTK::Infinity);
//    ExternalForce* transformPointExpressedInGroundToAppliedBody(const ExternalForce &exForce, const Storage &kinematics, osim_double_adouble startTime, osim_double_adouble endTime);
//
//private:
//    void setNull();
