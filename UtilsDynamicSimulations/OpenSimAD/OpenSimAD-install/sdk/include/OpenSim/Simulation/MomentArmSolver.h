...
namespace OpenSim {
    ...
    */
    ...
    public:
        ...
        */
        osim_double_adouble solve(const SimTK::State& state, const Coordinate &coordinate,
...
//////		//SimTK::Vector computeCouplingVector(SimTK::State &state,
//////		//	const Coordinate &coordinate) const;
//////		//void computeCouplingVector(SimTK::State &state,
//////		//	const Coordinate &coordinate, SimTK::Vector &couplingVector) const;
//////		/*void computeCouplingVector(SimTK::State &state,
//////		const Coordinate &coordinate, SimTK::Vector &_coupling) const;*/
//////		//=============================================================================
//////	};  // END of class MomentArmSolver
//////		//=============================================================================
//////} // namespace
