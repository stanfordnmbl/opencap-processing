...
all_bad_data = \
{
 ...
 '74cd2ec6-de3c-4a0e-a8c9-44edbffe0b86_005': {'session': '74cd2ec6-de3c-4a0e-a8c9-44edbffe0b86',
  ...
  'start': np.nan,
  'end': np.nan},
 '74cd2ec6-de3c-4a0e-a8c9-44edbffe0b86_006': {'name': 'TUGfast',# coming very close to the end
 ...
 'd9538893-e95c-4e28-960e-dd4aa0760942_012': {'name': 'tug_line',
  ...
  'start': np.nan,
  'end': np.nan},
 '8963b080-d316-4183-8928-47bebcac70b1_013': {'name': '10mwt',# TO REPROCESS, not sure it will help
 ...
 '9ce91ceb-2bf8-4544-ae22-3da5ad3cb9a1_016': {'session': '9ce91ceb-2bf8-4544-ae22-3da5ad3cb9a1',
  ...
  'start': np.nan,
  'end': np.nan},
 '9c4666be-57f4-4a6b-9c51-7e394f4a53e1_017': {'name': 'tug_line', # person in the fov
 ...
 'f249a8d6-9965-4240-94c3-e42a6b4bccf6_018': {'name': 'brooke',
  ...
  'start': np.nan,
  'end': np.nan},
 '43db734e-13fb-4d6d-9223-09f967dd40f0_019': {'name': 'toe_stand', # nothing obvious
  'session': '43db734e-13fb-4d6d-9223-09f967dd40f0',
  'start': np.nan,
  'end': np.nan},
 '8b7a734d-2874-42f7-94a2-c6026ec35d99_020': {'name': '10mwrt',# fast run
 ...
 'a08ec9d6-24f8-44f7-a59c-f603b7517e4d_023': {'session': 'a08ec9d6-24f8-44f7-a59c-f603b7517e4d',
  ...
  'start': np.nan,
  'end': np.nan},
 '38a56b81-3e2c-4854-93a4-333b66c8e0f1_024': {'name': 'toe_stand',# nothing obvious
 ...
 '9108903d-26b3-479a-ad49-955aebb868c7_025': {'session': '9108903d-26b3-479a-ad49-955aebb868c7',
  ...
  'start': np.nan,
  'end': np.nan},
 '002ea0b9-a2b6-4983-a876-275e3087ef1e_026': {'name': 'brooke',  # nothing obvious
 ...
 'b233300d-2c6d-4735-aadb-c597da014629_027': {'session': 'b233300d-2c6d-4735-aadb-c597da014629',
  ...
  'start': np.nan,
  'end': np.nan},
 '68cf5eec-1d9b-4630-8585-c9094d2de82c_028': {'name': 'TUGCone',# leaving the fov
 ...
 'e91690d8-1a0d-4031-a7ad-3fb1e23d7c36_029': {'session': 'e91690d8-1a0d-4031-a7ad-3fb1e23d7c36',
  ...
  'start': np.nan,
  'end': np.nan},
 '3a681925-50b5-470e-a44a-c1cab743f58b_030': {'name': '10mwt',# nothing obvious, quality seems bad (clinic)
 ...
 '773c33cd-a12d-46d2-af17-35fa7b4e83bd_031': {'session': '773c33cd-a12d-46d2-af17-35fa7b4e83bd',
  ...
  'start': np.nan,
  'end': np.nan},
 '725e0d28-d043-44bd-9f3e-0e58338a6bc4_032': {'name': '10mwrt', # TO REPROCESS
 ...
 'cbb0e8bc-8ed0-4af5-a20d-0a54650a3375_035': {'name': '5TSTS',
  ...
  'start': np.nan,
  'end': np.nan},
 '59f3fc4e-674f-43cc-9fdc-e9a2cf0a109e_036': {'name': 'tug_line_1',# nothing obvious, quality seems bad (clinic) 
 ...
 'a0d8b67a-89b0-45a7-a634-348ef2bcca5a_038': {'name': '10mwt',
  ...
  'start': np.nan,
  'end': np.nan},
 '623a4fe2-bc1e-4248-920a-e35416d1350d_039': {'name': '10mwrt',# fast run
 ...
 'de9b2159-afd0-4e11-8259-8f7d4e2e8ca5_051': {'session': 'de9b2159-afd0-4e11-8259-8f7d4e2e8ca5',
  ...
  'start': np.nan,
  'end': np.nan},
 '22fab7ce-b219-4c5d-84a4-e780816d46ea_052': {'name': 'tug_line_1', # exiting the fov
 ...
 '8d2f7856-3996-462f-bb2b-f020e7053a90_053': {'session': '8d2f7856-3996-462f-bb2b-f020e7053a90',
  ...
  'start': np.nan,
  'end': np.nan},
 '316ac7bf-12a8-4b1b-84db-56a9a7f9d70b_054': {'name': '5xsts',# nothing obvious, quality seems bad (clinic)
 ...
 '9871c398-0d02-450b-86a6-0d8c6b27b26d_059': {'name': '5xsts',
  ...
  'start': np.nan,
  'end': np.nan},
 '2aff7769-ee45-4e3d-a8cc-266d5b886a10_060': {'name': 'toe_stand',# nothing obvious except wearing a dress.
  'session': '2aff7769-ee45-4e3d-a8cc-266d5b886a10',
  'start': np.nan,
  'end': np.nan},
 '057d10da-34c7-4fb7-a127-6040010dde06_061': {'name': 'brooke_sit',  # nothing obvious
  'session': '057d10da-34c7-4fb7-a127-6040010dde06',
  'start': np.nan,
  'end': np.nan},
 '8bf259f7-000f-4474-9ad4-255949bdaf71_062': {'name': 'brooke',# nothing obvious
  'session': '8bf259f7-000f-4474-9ad4-255949bdaf71',
  'start': np.nan,
  'end': np.nan},
 '18f57fa8-41a0-4d8d-b7a3-d0c838516f24_063': {'name': 'brooke',  # hands hidden
  'session': '18f57fa8-41a0-4d8d-b7a3-d0c838516f24',
  'start': np.nan,
  'end': np.nan},
 '4c46fbb5-4ab8-49ff-b90d-5e8a38c5bcff_064': {'name': 'brooke',# nothing obvious
 ...
 '822926eb-1c7d-4298-84c5-7ead6909387b_067': {'name': 'tug_cone_2',
  ...
  'start': np.nan,
  'end': np.nan},
#  '9108903d-26b3-479a-ad49-955aebb868c7_068': {'session': '9108903d-26b3-479a-ad49-955aebb868c7',  # missing video
#   'name': 'Curl',
#   'start': np.nan,
#   'end': np.nan},
 '8d2f7856-3996-462f-bb2b-f020e7053a90_069': {'session': '8d2f7856-3996-462f-bb2b-f020e7053a90',
  ...
  'start': np.nan,
  'end': np.nan},
 '8d2f7856-3996-462f-bb2b-f020e7053a90_070': {'name': 'Brooke', # missing video
  'session': '8d2f7856-3996-462f-bb2b-f020e7053a90',
  'start': np.nan,
  'end': np.nan},
#  'ca174c27-d0fe-4edd-8799-9ef3ea053086_071': {'session': 'ca174c27-d0fe-4edd-8799-9ef3ea053086', # missing video
#   'name': 'TIPTOE',
#   'start': np.nan,
#   'end': np.nan},
 ...
 'ca174c27-d0fe-4edd-8799-9ef3ea053086_073': {'name': 'JUMP',
  ...
  'start': np.nan,
  'end': np.nan},
 '31b45d11-f909-42e5-b404-3451b4b6d238_074': {'name': 'TUG',# Leaving the fov
 ...
 'ee86be93-b1da-4080-b445-176f6071e734_078': {'session': 'ee86be93-b1da-4080-b445-176f6071e734',
  ...
  'start': np.nan,
  'end': np.nan},
 '76b201f8-1950-414e-a48a-97bf932c61bc_079': {'name': '10mwt', # TO REPROCESS
 ...
 '4769f868-d487-4e0d-bda6-98eb6751b40a_081': {'session': '4769f868-d487-4e0d-bda6-98eb6751b40a',
  ...
  'start': np.nan,
  'end': np.nan},
 '4769f868-d487-4e0d-bda6-98eb6751b40a_082': {'name': 'jump', # video missing
 ...
 'ee86be93-b1da-4080-b445-176f6071e734_086': {'name': '10mwt_2',
  ...
  'start': np.nan,
  'end': np.nan},
#  '9ce91ceb-2bf8-4544-ae22-3da5ad3cb9a1_087': {'session': '9ce91ceb-2bf8-4544-ae22-3da5ad3cb9a1', # missing video
#   'name': '10mwrt',
#   'start': np.nan,
#   'end': np.nan},
 '6537ecc8-e44b-4405-a9fe-c09ede5e0550_088': {'name': '5xsts', # TO REPROCESS
 ...
 'cda2db6e-b268-42ee-99d0-9cc358e893d1_089': {'name': '10mwrt',
  ...
  'start': np.nan,
  'end': np.nan},
 '621e5ae8-226b-4fc6-bbd9-df448328ff1f_090': {'name': 'jump_1',# no jump recorded
  'session': '621e5ae8-226b-4fc6-bbd9-df448328ff1f',
  'start': np.nan,
  'end': np.nan},
 '6de88f3d-b84a-4ee5-8003-a5fbb994278e_091': {'name': '10mwt',# nothing obvious
 ...
 'd37407d6-83a8-44f8-b5b2-c651db8edd9f_092': {'name': 'jump',
  ...
  'start': np.nan,
  'end': np.nan},
 '4d0cfa49-baa9-4e49-8b34-2bc6727f6052_093': {'name': '10mwt',# nothing obvious
 ...
 'e91690d8-1a0d-4031-a7ad-3fb1e23d7c36_094': {'name': '10mwt',
  ...
  'start': np.nan,
  'end': np.nan},
 '5a3dd4e7-7293-46e6-9c0c-b77e2511860d_095': {'name': '10mwrt',# nothing to do, crazy run
 ...
 'bc4dd6dc-d9d2-4345-b130-d42bb1c4d673_099': {'session': 'bc4dd6dc-d9d2-4345-b130-d42bb1c4d673',
  ...
  'start': np.nan,
  'end': np.nan},
 '07d80cd7-3634-4485-b3a7-a9d592cf82b0_100': {'name': 'Brooke', # nothing obvious, quality seems bad (clinic)
 ...
 'faa79e6d-f90e-4399-8b68-9e9f2dd00027_101': {'name': 'HOP',
  ...
  'start': np.nan,
  'end': np.nan},
 '34f2095f-d076-4a3d-b094-75f968a93c21_102': {'name': 'jump',# nothing obvious
 ...
 'ca44b787-96c1-4ed3-8151-89b4bd4310c4_103': {'name': 'toe_stand',
  ...
  'start': np.nan,
  'end': np.nan},
 '2f6340cd-d4ad-4ef1-b8c3-d1296821c78f_104': {'name': 'tug_cone',# nothing obvious, maybe Tina in the fov
 ...
 'a08ec9d6-24f8-44f7-a59c-f603b7517e4d_105': {'name': 'tug_cone',
  ...
  'start': np.nan,
  'end': np.nan},
 '78d9fbfe-04e0-4766-ba15-198e246d5e9c_106': {'name': '10mwt',# people in the background, should have been handled, nothing else obvious
  'session': '78d9fbfe-04e0-4766-ba15-198e246d5e9c',
  'start': np.nan,
  'end': np.nan},
 '773c33cd-a12d-46d2-af17-35fa7b4e83bd_107': {'name': 'tug_cone',# people in the background, should have been handled, nothing else obvious
 ...
 'a7675b05-88da-4bb0-b27b-5357c3ec5807_110': {'name': 'tug_cone',
  ...
  'start': np.nan,
  'end': np.nan},
 '7d9b3d14-2672-458a-94df-d35c7b5cdcf5_111': {'name': '5xsts',# nothing obvious, quality seems bad (clinic)
 ...
 '9108903d-26b3-479a-ad49-955aebb868c7_112': {'name': 'TUGfast',
  ...
  'start': np.nan,
  'end': np.nan},
 '25ebd0a3-e8ce-4a7a-ad91-0c1d94753b69_113': {'name': 'jump',# TO REPROCESS
  'session': '25ebd0a3-e8ce-4a7a-ad91-0c1d94753b69',
  'start': 2,
  'end': np.nan},
 '90e3af8d-3aac-4d97-ac5a-70f5c4e911ae_114': {'name': 'tug_cone',# people in the background, should have been handled, nothing else obvious
 ...
 'bc4dd6dc-d9d2-4345-b130-d42bb1c4d673_115': {'name': '5TSTS',
  ...
  'start': np.nan,
  'end': np.nan},
 '65aa878e-4396-4a9c-a9a0-7a1e2c708f83_116': {'name': 'ARM_ROM',# nothing obvious, quality seems bad (clinic) 
  'session': '65aa878e-4396-4a9c-a9a0-7a1e2c708f83',
  'start': np.nan,
  'end': np.nan},
 '1fc22b0c-1ef8-4b6d-b83b-85b12634905d_117': {'name': '10mwrt_1', # TO REPROCESS
  'session': '1fc22b0c-1ef8-4b6d-b83b-85b12634905d',
  'start': 3,
  'end': np.nan},
 '28ec73c6-025b-4ea4-b844-803e8205bf1a_118': {'name': 'brooke',# hands hidden
 ...
 '51003106-cdec-40f7-9204-0e21953bb4a7_119': {'name': '10mwt',
  ...
  'start': np.nan,
  'end': np.nan},
 '109eabdf-e50d-459e-8917-c856338a720b_120': {'name': '10mwrt', # TO REPROCESS, not sure that will help
 ...
 'aca92056-3f67-403c-8d6a-513055274ffe_123': {'name': '5xsts',
  ...
  'start': np.nan,
  'end': np.nan},
 '25d785ae-f49e-4531-b14c-86d6d5e9d144_124': {'name': 'toe_stand',# TO REPROCESS
  'session': '25d785ae-f49e-4531-b14c-86d6d5e9d144',
  'start': 0,
  'end': 31},
 '9e5d7c34-d9fc-43f7-85e9-d3e5def7ef3a_125': {'name': '10mrt', # fast run
 ...
 'bca0aad8-c129-4a62-bef3-b5de1659df5e_126': {'name': 'tug_cone',
  ...
  'start': np.nan,
  'end': np.nan},
 '98fc0617-1f5e-44ba-92c9-a32f09899295_127': {'name': 'brooke',# nothing obvious
